...
export default function InsightClient({ insight }: Props) {
            ...
            <div className="sticky top-32 space-y-8">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                ...
                <div className="flex gap-2">
                  ...
                  <button 
                    onClick={() => alert('Thanks for liking!')}
              ...
              <div className="mt-16">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {insight.relatedInsights.slice(0, 3).map((slug, i) => {
                    // Import insights di sini
                    const { insights } = require("@/lib/insights")
                    const related = insights.find((ins: any) => ins.slug === slug.replace('/insight/', ''))
