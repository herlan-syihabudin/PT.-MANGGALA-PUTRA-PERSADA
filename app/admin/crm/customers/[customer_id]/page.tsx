  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <Info label="Jenis Customer" value={customer.customer_type} />
        <Info label="PIC" value={customer.pic_name} />
        <Info label="Jabatan PIC" value={customer.pic_position || "-"} />
        ...
        <Info
          label="Dibuat"
          value={new Date(customer.created_at).toLocaleString("id-ID")}
        />
      </div>
