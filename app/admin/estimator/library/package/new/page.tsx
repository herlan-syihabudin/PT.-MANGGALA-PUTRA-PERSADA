...
export default function NewPackagePage() {
  ...
  cache: 'no-store'
      ...
      if (json.success) {
        // Flatten all items from all packages
        const allItems: AvailableJob[] = []
  ...
  }, [availableJobs, searchJob, selectedCategory])

  // ========== ITEM HANDLERS ==========
  const addItemToPackage = (job: AvailableJob) => {
    // Prevent duplicate
    if (items.some(i => i.jobId === job.jobId)) {
      return
    }
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="p-6 border-b bg-gray-50">
                  <div className="flex items-center justify-between">
                    <h2 className="text-lg font-semibold flex items-center gap-2">
                      ...
                      {items.length === 0 && (
                        <span className="text-xs text-red-500 ml-2">*Minimal 1 item</span>
                      )}
                    </h2>
                    <button
                      type="button"
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-white border rounded-xl p-4">
                  ...
                  <p className="text-xl font-bold mt-1">{uniqueCategories}</p>
                </div>
                <div className="bg-white border rounded-xl p-4">
          ...
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[80vh] flex flex-col">
            ...
            <div className="p-4 border-b bg-gray-50">
              ...
              <p className="text-xs text-gray-400 mt-2">
                {filteredJobs.length} items available
              </p>
            </div>
              ...
              {loadingJobs ? (
                ...
                <div className="space-y-2">
                  {filteredJobs.map((job) => {
                    const isAdded = items.some(i => i.jobId === job.jobId)
                    return (
                      <button
                        key={job.id}
                        ...
                        disabled={isAdded}
                        className={`
                          w-full text-left p-3 border rounded-lg transition 
