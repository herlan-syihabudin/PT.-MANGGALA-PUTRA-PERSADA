export const fitOutServiceSchema = {
  ...
  image: "https://mppindo.com/images/services/fit-out.jpg",
  ...
  serviceOutput: [
    ...
    "Industrial Interior Facilities"
  ],
  ...
  keywords: [
    "interior fit-out contractor indonesia",
    "office interior construction",
    "commercial interior contractor",
    "industrial interior fit-out",
    "fit-out contractor jakarta"
  ],
